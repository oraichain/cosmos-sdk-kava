...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/kava-labs/cosmos-sdk/types/errors.Wrap",
		"github.com/kava-labs/cosmos-sdk/types/errors.Wrapf",
		"github.com/kava-labs/cosmos-sdk/types/errors.WithType",
